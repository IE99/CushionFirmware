...
//   //(220) /* OTA Client & Server supported ATT_MTU */
...
//#endif
#define OTA_MAX_ATT_MTU_SIZE    	220
/* Number of services requests in pressure cushion */
#define NUM_APP_GATT_SERVICES 		12

/* Number of attributes requests in pressure cushion */
#define NUM_APP_GATT_ATTRIBUTES 	80

/* OTA characteristics maximum length */
#define OTA_MAX_ATT_SIZE 			(0)


#define MAX_CHAR_LEN(a,b) ((a) > (b) )? (a) : (b)

/* Application characteristics maximum length */
...
#define ATT_VALUE_ARRAY_SIZE    (43 + 106 + 300 + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 43 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28) , Pressure (29), Humidity (28) characteristics)  Services
